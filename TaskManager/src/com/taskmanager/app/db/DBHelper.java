package com.taskmanager.app.db;
...
public class DBHelper {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			// 创立表结构
			db.execSQL("create table tsm_task (id integer primary key autoincrement,"
					+ "name varchar(255),startTime datetime,endTime datetime,"
					+ "note varchar(1000),isNotification boolean,isFinish boolean);");
		}
	 ...
	 * @throws SQLException
	 */
	public Cursor findOne(boolean distinct, String tableName, String[] columns,
